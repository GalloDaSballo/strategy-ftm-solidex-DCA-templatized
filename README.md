...
- Basic Solidity Smart Contract for creating your own Badger Strategy ([`contracts/StrategyGenericSolidexDCA.sol`](contracts/StrategyGenericSolidexDCA.sol))
...
2. Write the Strategy Code in StrategyGenericSolidexDCA.sol
...
[`contracts/StrategyGenericSolidexDCA.sol`](contracts/StrategyGenericSolidexDCA.sol) is where you implement your own logic for your strategy. In particular:

- Customize the `initialize` Method
- Set a name in `StrategyGenericSolidexDCA.getName()`
- Set a version in `StrategyGenericSolidexDCA.version()`
- Write a way to calculate the want invested in `StrategyGenericSolidexDCA.balanceOfPool()`
- Write a method that returns true if the Strategy should be tended in `StrategyGenericSolidexDCA.isTendable()`
- Set a version in `StrategyGenericSolidexDCA.version()`
